(function () {
  ...
  var a = class {
    ...
    advance(e) {
      ...
      if (this.duration && this.easing) {
        ...
        this.lerp
          ? ((this.value = r(this.value, this.to, this.lerp * 60, e)),
            Math.round(this.value) === Math.round(this.to) && ((this.value = this.to), (n = !0)))
  ...
  var s = class {
      ...
      constructor(e, t, { autoResize: n = !0, debounce: r = 250 } = {}) {
        ((this.wrapper = e),
          (this.content = t),
          n &&
            ((this.debouncedResize = o(this.resize, r)),
  ...
  var d = class {
    ...
    onWheel = (e) => {
      let { deltaX: t, deltaY: n, deltaMode: r } = e,
        i = u(r, this.window.width),
        a = u(r, this.window.height);
      ((t *= i),
        (n *= a),
  ...
  var p = class {
    ...
    constructor({
      ...
      ((window.lenisVersion = e),
        window.lenis || (window.lenis = {}),
        (window.lenis.version = e),
        h === `horizontal` && (window.lenis.horizontal = !0),
        a === !0 && (window.lenis.touch = !0),
        ...
        (this.dimensions = new s(t, n, { autoResize: y })),
        ...
        (this.virtualScroll = new d(r, { touchMultiplier: _, wheelMultiplier: v })),
        this.virtualScroll.on(`scroll`, this.onVirtualScroll),
        this.options.autoToggle &&
          (this.checkOverflow(), this.rootElement.addEventListener(`transitionend`, this.onTransitionEnd)),
    ...
    dispatchScrollendEvent = () => {
      this.options.wrapper.dispatchEvent(
        new CustomEvent(`scrollend`, { bubbles: this.options.wrapper === window, detail: { lenisScrollEnd: !0 } }),
      );
    };
    get overflow() {
    ...
    onVirtualScroll = (e) => {
      ...
      if (
        (this.emitter.emit(`virtual-scroll`, { deltaX: t, deltaY: n, event: r }), r.ctrlKey || r.lenisStopPropagation)
      )
        return;
        ...
        c.find(
          (e) =>
            ...
            ((typeof l == `function` && l?.(e)) ||
              ...
              (this.options.allowNestedScroll && this.hasNestedScroll(e, { deltaX: t, deltaY: n }))),
        )
      )
        return;
        ...
        if (
          (typeof m == `string`
            ? ((e = document.querySelector(m)),
              e || (m === `#top` ? (m = 0) : console.warn(`Lenis: Target not found`, m)))
